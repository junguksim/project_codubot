...
if (window.location.href.indexOf("lang=en") >= 0 ||
  ...
  goog.require('Blockly.Msg');
      ...
      /** @export */ Blockly.Msg.CODUBOT_INIT = 'INIT CODUBOT';
      /** @export */ Blockly.Msg.ROBOT_MOVE_ANGLE = 'MOVE ROBOT BY ANGLE';
      /** @export */ Blockly.Msg.ROBOT_TURN = 'ROBOT TURN';
      /** @export */ Blockly.Msg.ROBOT_STOP = 'STOP ROBOT';
      /** @export */ Blockly.Msg.ROBOT_MOVE_DIST = 'MOVE ROBOT BY DIST';
      /** @export */ Blockly.Msg.MOTOR_MOVE = 'MOTOR MOVE';
      /** @export */ Blockly.Msg.MOTOR_STOP = 'MOTOR STOP';
      /** @export */ Blockly.Msg.ROBOT_TURN_SQUARE = 'MOVE ROBOT TURN SQUARE';
      /** @export */ Blockly.Msg.RIGHT_MOTER = 'RIGHT MOTOR';
      /** @export */ Blockly.Msg.LEFT_MOTOR = 'LEFT MOTOR';
      /** @export */ Blockly.Msg.FORWARD = 'FORWARD';
      /** @export */ Blockly.Msg.BACKWARD = 'BACKWARD';
