...
(function(){
  ...
  function init()
  {
    ...
    html+='  <p><img src="img/logo.png" height=256px weight=256px alt="적층형 교육 로봇 IDE"/></p></br></br>\n';
    html+='  <p id="versioninfo" style="text-align:right"></p>\n';
    html+='  <h2 style="text-align:center;font-weight:bold">교육 로봇 개발을 위해서 개발 되었습니다.</h2></br>\n';
    html+='  <h3>소스 코드 변경 후에도 구동에 이상이 없는 지 테스트 하기 위하여 다음과 같은 글을 한글로 작성합니다.</h3>\n';
    html+='  <h3>아파치 라이센스 2.0 과 MIT 라이센스를 사용하기 때문에 소스 코드 변경 후에도 독립적인 형태로 배포할 수 있습니다.</h3>.\n';
    html+='</div>\n';
